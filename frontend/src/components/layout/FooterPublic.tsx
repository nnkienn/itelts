...
export default function Footer() {
    return (
        <footer className="bg-[#c6cfeb] text-white py-10">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-start gap-3">
                    ...
                    <p className="text-sm text-gray-400 max-w-xs">
                        LexiBot is a versatile AI-powered service helping people learn & write in a second language.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="flex gap-6 font-semibold">
                        <Link href="/affiliate" className="hover:text-teal-400">Become an Affiliate</Link>
